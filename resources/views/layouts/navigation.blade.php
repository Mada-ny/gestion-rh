<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @role('employe')
                        <x-nav-link :href="route('employes.show', Auth::user()->employe)" :active="request()->routeIs('employes.show')">
                            {{ __('Mes Infos') }}
                        </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @role('employe')
            <x-responsive-nav-link :href="route('employes.show', Auth::user()->employe)" :active="request()->routeIs('employes.show')">
                {{ __('Mes Infos') }}
            </x-responsive-nav-link>
        ...
        @role('drh')
            <x-responsive-nav-link :href="route('employes.index')" :active="request()->routeIs('employes.index')">
                {{ __('Employés') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('absences.index')" :active="request()->routeIs('absences.index')">
                {{ __('Absences') }}
        ...
        <x-responsive-nav-link :href="route('conges.index')" :active="request()->routeIs('conges.index')">
            {{ __('Congés') }}
        </x-responsive-nav-link>
        </div>
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <div class="px-4">
                <div class="font-medium text-base text-gray-800">{{ Auth::user()->prénom }}</div>
